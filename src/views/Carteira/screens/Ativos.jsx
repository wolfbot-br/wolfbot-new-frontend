...
class TablePosicoes extends Component {
  ...
  render() {
    ...
    },
    {
      ...
      Cell: row => (
        <div>
          <Button className='btn-simple btn-success btn-sm mr-1 margin-right: 1rem'>Vender Tudo</Button>
        </div>
      ),
      headerClassName: "text-center",
      sortable: false,
    ...
    return (
      <Card>
        <CardHeader>
          <CardTitle>
            <i className='tim-icons icon-wallet-43 text-success' /> Carteira de Ativos
        </CardTitle>
        </CardHeader>
